...
@section('content')
<a href="{{ route('v2.branch.subjects') }}" style="font-size: 13px; color: var(--text-soft); text-decoration: none; display: inline-flex; align-items: center; gap: 4px; margin-bottom: 16px;">
        ...
        <table class="tbl" style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                @foreach ($classes as $c)
                    <tr style="border-bottom: 1px solid var(--border); cursor: pointer;" onclick="window.location='{{ route('v2.branch.class', hid($c['id'])) }}'">
