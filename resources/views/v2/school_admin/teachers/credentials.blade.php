...
@section('page_title', isset($isReset) ? 'Password Reset' : 'Teacher Credentials')
...
<div style="max-width: 640px;">
    ...
    <div style="background: var(--surface); border: 1px solid var(--border); border-radius: 12px; padding: 28px;">
        <div style="margin-bottom: 20px;">
            <div style="font-size: 13px; color: var(--muted); font-weight: 600; text-transform: uppercase; letter-spacing: .05em; margin-bottom: 4px;">Teacher</div>
            <div style="font-size: 18px; font-weight: 600; color: var(--text);">{{ $teacher->name }}</div>
        </div>
        ...
        <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid var(--border); display: flex; gap: 12px;">
            <a href="{{ route('v2.school.teachers.index') }}"
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--border);">
                    ...
                    <td style="padding: 12px 16px; font-size: 14px; font-weight: 500; color: var(--text);">{{ $row['teacher']->name }}</td>
                    <td style="padding: 12px 16px; font-size: 13px; color: var(--muted);">{{ $row['teacher']->email }}</td>
