...
<div class="grid" style="min-height: 100vh; grid-template-columns: 1.05fr 1fr; background: var(--ivory-deep);">
    ...
    <div class="relative flex flex-col" style="background: linear-gradient(135deg, var(--emerald-900), var(--emerald-800) 70%); color: var(--ivory); padding: 60px 70px; overflow: hidden;">
        ...
        <div class="relative" style="margin-top: auto; z-index: 1;">
            <div class="uppercase-eyebrow" style="color: var(--accent); font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase;">Platform Administration</div>
            <h1 class="serif" style="font-size: 44px; font-weight: 600; line-height: 1.05; margin-top: 12px; letter-spacing: -0.02em;">
                Super Admin <em style="color: var(--accent); font-style: italic;">Portal</em>
            </h1>
            <p style="font-size: 16px; color: rgba(250,247,239,0.75); line-height: 1.6; max-width: 420px; margin-top: 16px;">
                Platform-level access. Manage schools, monitor usage, and administer the entire TopicalEd network from a single dashboard.
            </p>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center" style="padding: 40px 60px;">
        <div style="width: 100%; max-width: 400px;">
            <div style="font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: var(--text-faint);">Restricted Access</div>
            <h2 class="serif" style="font-size: 30px; font-weight: 600; margin-top: 8px; letter-spacing: -0.01em;">Sign in</h2>
            <p style="color: var(--text-soft); margin-top: 6px; font-size: 14px;">Super Admin credentials required.</p>
            ...
            <form method="POST" action="{{ route('v2.super_admin.login.post') }}" style="margin-top: 28px;">
                @csrf
                <label class="label">Email address</label>
                <input class="input" type="email" name="email" value="{{ old('email') }}"
                       placeholder="admin@generativetopical.com" autofocus required autocomplete="email"/>
            ...
            <a href="{{ route('home') }}" class="btn btn-ghost btn-sm" style="margin-top: 20px; width: 100%;">
