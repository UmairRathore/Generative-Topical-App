...
@section('page_title', $school->name.' — Subjects')
...
<p style="color: var(--text-soft); font-size: 13px; margin-bottom: 22px;">Performance by subject across {{ $school->name }}.</p>
...
<div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--r-lg); overflow: hidden;">
    <table class="tbl" style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            @forelse ($rows as $r)
                <tr style="border-bottom: 1px solid var(--border); cursor: pointer;" onclick="window.location='{{ route('v2.super_admin.schools.subjects.show', [$school, hid($r['id'])]) }}'">
