...
@section('page_title', 'Grades — platform')
...
<h2 class="serif" style="font-size: 26px; font-weight: 600; margin-bottom: 3px;">Grades across all schools</h2>
<p style="color: var(--text-soft); font-size: 13px; margin-bottom: 22px;">Grouped by grade name. Schools that label the same grade differently won't merge.</p>

<div style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--r-lg); overflow: hidden;">
    <table class="tbl" style="width: 100%; border-collapse: collapse;">
        <thead>
            <tr style="background: var(--soft-surface); border-bottom: 1px solid var(--border);">
                @foreach (['Grade', 'Schools', 'Classes', 'Students', 'Exams', 'Subs', 'Avg'] as $h)
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="7" style="padding: 40px; text-align: center; color: var(--text-faint); font-size: 14px;">No grades yet.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
