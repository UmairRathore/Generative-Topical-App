...
<div class="grid" style="min-height: 100vh; grid-template-columns: 1.05fr 1fr; background: var(--ivory-deep);">
    ...
    <div class="relative flex flex-col" style="background: linear-gradient(135deg, var(--emerald-900), var(--emerald-800) 70%); color: var(--ivory); padding: 60px 70px; overflow: hidden;">
        ...
        <div class="relative" style="margin-top: auto; z-index: 1;">
            <div style="font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: var(--accent);">Cambridge MCQ Practice</div>
            ...
            <p style="font-size: 16px; color: rgba(250,247,239,0.75); line-height: 1.6; max-width: 420px; margin-top: 16px;">
                Practise topical MCQs, track your weak areas, and prepare for Cambridge O & A Levels with confidence.
            </p>
        </div>
    </div>
    ...
    <div class="flex items-center justify-center" style="padding: 40px 60px;">
        <div style="width: 100%; max-width: 400px;">
            <div style="font-size: 11px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: var(--text-faint);">Student Sign In</div>
            <h2 class="serif" style="font-size: 30px; font-weight: 600; margin-top: 8px; letter-spacing: -0.01em;">Welcome back</h2>
            <p style="color: var(--text-soft); margin-top: 6px; font-size: 14px;">Use your school-issued login to continue.</p>
            ...
            <form method="POST" action="{{ route('v2.student.login.post') }}" style="margin-top: 28px;">
                @csrf
                <label class="label">Email address</label>
                <input class="input" type="email" name="email" value="{{ old('email') }}"
                       placeholder="student@school.edu.pk" autofocus required autocomplete="email"/>
